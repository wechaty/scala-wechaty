...
import wechaty.puppet.schemas.Event.{EventFriendshipPayload, EventLoginPayload, EventLogoutPayload, EventMessagePayload, EventScanPayload}
import wechaty.user.{Contact, ContactSelf, Friendship, Message}
