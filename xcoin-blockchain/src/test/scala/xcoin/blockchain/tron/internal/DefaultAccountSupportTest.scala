...
import xcoin.blockchain.tron.services.TronPermissionHelper.TronPermissionWrapper
import xcoin.blockchain.tron.services.TronApi.TronPermission

@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE,
                classes=Array(classOf[TestNileConfiguration]))
class DefaultAccountSupportTest {
  private val logger = Logger[DefaultAccountSupportTest]
  @Autowired
